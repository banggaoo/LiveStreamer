    ...
    var data: Data {
        ...
        set {
            ...
            for i in 0..<bytes.count {
                guard let line: String = String(bytes: [UInt8](bytes[i]), encoding: .utf8) else { continue }
            ...
            guard let first: [String] = lines.first?.components(separatedBy: " "), first.count >= 3 else { return }
